...
broadcasts, media/templates, cross-system contact merge and Automation Studio
...
- `apps/api`: NestJS API, Telegram webhook, CRM service contracts and health
  endpoints.
- `apps/worker`: BullMQ consumers for inbox/outbox, CRM, broadcasts,
  continuations and external HTTP operations.
